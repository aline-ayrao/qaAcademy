...
public class Execucao {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("A subtração é: " + exercicio05_easy.subtracao(num1, num2, num3));
        System.out.println("A multiplicação é: " + exercicio05_easy.multiplicacao(num1, num2, num3));
